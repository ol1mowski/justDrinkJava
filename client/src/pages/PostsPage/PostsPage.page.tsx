        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center py-16">
            <div className="max-w-md mx-auto">
              ...
              <p className="text-java-blue/90 mb-6">{error}</p>
              <button
        ...
        <div className="py-16 bg-gradient-to-r from-java-orange/5 to-java-blue/5">
          <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
            ...
            <p className="text-java-blue/90 mb-8">
              Sprawdź nasze inne sekcje lub skorzystaj z wyszukiwania, aby
              znaleźć dokładnie to, co Cię interesuje.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <button
                onClick={() =>
                  setFilters({ searchQuery: '', category: undefined })
                }
