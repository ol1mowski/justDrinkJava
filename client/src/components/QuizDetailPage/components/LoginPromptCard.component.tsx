...
export const LoginPromptCard = memo<LoginPromptCardProps>(
  ({ score, correctAnswers, onNavigateToLogin }) => {
        ...
        <div className="text-center">
          ...
          <p className="text-gray-600 leading-relaxed mb-6">
            ...
            <span className="font-bold text-java-orange">
              {earnedPoints} punktów
            </span>{' '}
            za ten quiz! Zaloguj się, aby zapisać swoje wyniki i rywalizować z
            innymi użytkownikami w rankingu.
          </p>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
            <div className="text-center p-4 bg-white/80 rounded-xl border border-gray-100">
              <div className="text-2xl font-bold text-java-orange">
                {earnedPoints}
              </div>
