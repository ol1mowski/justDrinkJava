...
export const CVCareerTipsAuthenticated = memo<CVCareerTipsAuthenticatedProps>(
  ({ user }) => (
    <>
      ...
      <div className="mt-16 text-center bg-gradient-to-r from-java-blue to-java-orange rounded-xl p-8 text-white">
        ...
        <p className="text-lg opacity-90 mb-6">
          Pamiętaj: każdy ekspert był kiedyś początkującym. Kluczem jest
          konsekwencja i ciągłe uczenie się!
        </p>
