...
export const CVSkillsSection = memo<CVSectionContentProps>(({ activeTooltip, onSectionClick }) => (
  <CVSection
    id="skills"
  ...
  >
    <div className="py-6 border-b border-java-orange/20">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div>
          <h4 className="font-semibold text-java-blue/80 mb-3">DevOps & Narzędzia</h4>
          <div className="space-y-2 text-sm">
            <div className="flex justify-between">
