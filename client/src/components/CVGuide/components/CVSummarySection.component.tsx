...
export const CVSummarySection = memo<CVSectionContentProps>(
    ...
    >
      <div className="py-6 border-b border-java-orange/20">
        <p className="text-java-blue/80 leading-relaxed">
          Doświadczony Java Developer z 5-letnim stażem w tworzeniu aplikacji
          enterprise. Specjalizuję się w Spring Boot, mikrousługach i
          architekturze chmurowej. Szukam możliwości rozwoju w zespole
          pracującym nad innowacyjnymi rozwiązaniami fintech.
        </p>
