...
export const CVExperienceSection = memo<CVSectionContentProps>(
    ...
    >
      <div className="py-6 border-b border-java-orange/20 space-y-6">
        <div>
          ...
          <p className="text-java-orange font-medium mb-2">
            TechCorp Sp. z o.o.
          </p>
          <ul className="text-java-blue/80 space-y-1 text-sm">
            <li>
              • Zbudowałem system płatności obsługujący 50k transakcji dziennie
              używając Spring Boot i PostgreSQL
            </li>
            <li>
              • Zoptymalizowałem zapytania bazodanowe, redukując czas odpowiedzi
              o 60%
            </li>
            <li>
              • Wdrożyłem CI/CD pipeline z Jenkins, skracając czas deploymentu z
              2h do 15min
            </li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="text-java-blue/80 space-y-1 text-sm">
            <li>
              • Rozwijałem aplikację e-commerce w Spring MVC obsługującą 10k
              użytkowników
            </li>
