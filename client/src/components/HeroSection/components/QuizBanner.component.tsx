...
export const QuizBanner = memo(() => {
  return (
    <div className="relative group">
      ...
      <div className="relative p-6 lg:p-8 text-gray-800 dark:text-gray-200">
          ...
          <div className="flex-1">
            ...
            <div className="grid grid-cols-2 gap-3 mb-4 text-xs lg:text-sm">
              <div className="flex items-center gap-2">
                ...
                <span className="text-gray-600 dark:text-gray-300">Ranking graczy</span>
              </div>
              <div className="flex items-center gap-2">
                <AcademicCapIcon className="w-4 h-4 text-java-blue" />
                <span className="text-gray-600 dark:text-gray-300">Różne poziomy</span>
              </div>
            </div>
