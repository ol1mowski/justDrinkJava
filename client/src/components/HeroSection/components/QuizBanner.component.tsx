...
export const QuizBanner = memo(() => {
  return (
    <div className="relative group">
      <div
        className="absolute inset-0 bg-gradient-to-r from-gray-50 via-blue-50 to-indigo-50 
        ...
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            ...
            <p className="text-gray-600 mb-4 text-sm lg:text-base leading-relaxed">
              Rozwiązuj interaktywne quizy z Javy i sprawdź jak dobrze znasz ten
              język programowania. Zdobywaj punkty i rywalizuj z innymi
              developerami!
            </p>
