...
import { LockClosedIcon, ArrowRightIcon, TrophyIcon } from '@heroicons/react/24/outline'
...
export const UserRankingFooter = memo<UserRankingFooterProps>(({ isAuthenticated }) => {
