...
export const QuizCard = memo<QuizCardProps>(
  ({ quiz, isBlocked = false, onStartQuiz }) => {
            ...
            <div className="absolute inset-0 bg-white/90 backdrop-blur-sm rounded-2xl flex items-center justify-center z-10">
              <div className="text-center p-8">
                ...
                <p className="text-gray-600 mb-6 leading-relaxed">
                  Aby uzyskać dostęp do ekskluzywnych quizów musisz się
                  zalogować
                </p>
                <button
                  onClick={e => {
            ...
            <div className="flex items-start justify-between mb-6">
              <div className="flex items-center space-x-3">
                ...
                <div className="flex flex-col">
                  <span className="text-xs font-semibold text-java-orange uppercase tracking-wider">
                    Quiz
                  </span>
