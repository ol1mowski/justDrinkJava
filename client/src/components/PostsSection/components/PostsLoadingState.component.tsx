...
export const PostsLoadingState = memo<PostsLoadingStateProps>(({ itemsCount = 9 }) => {
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
      {[...Array(itemsCount)].map((_, index) => (
        <div key={index} className="bg-java-white dark:bg-java-dark-surface rounded-xl overflow-hidden 
