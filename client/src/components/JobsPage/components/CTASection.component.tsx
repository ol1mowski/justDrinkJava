  ...
  return (
    <div className="py-20 lg:py-28 bg-gradient-to-br from-java-orange/10 to-java-orange/5 dark:from-java-orange/20 dark:to-java-orange/10">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          Wykorzystaj nasz ranking, aby znaleźć idealną platformę do
          poszukiwania pracy. Sprawdź też nasze artykuły o przygotowaniu do
          rozmów rekrutacyjnych i rozwoju kariery w Java.
        </motion.p>
