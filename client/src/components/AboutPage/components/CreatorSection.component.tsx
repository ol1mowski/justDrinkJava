          ...
          <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-12">
            ...
            <div className="flex-1 text-center lg:text-left">
              ...
              <div className="space-y-4 text-java-blue leading-relaxed">
                ...
                >
                  Pasjonat programowania z ponad 8-letnim doświadczeniem w
                  ekosystemie Java. Specjalizuje się w Spring Boot,
                  mikrousługach i architekturze cloud-native.
                </motion.p>
                ...
                >
                  Gdy nie koduje, eksperymentuje z nowymi metodami parzenia kawy
                  i dzieli się wiedzą z społecznością programistów. Wierzy, że
                  najlepszy kod powstaje przy filiżance doskonale zaparzonej
                  kawy.
                </motion.p>
