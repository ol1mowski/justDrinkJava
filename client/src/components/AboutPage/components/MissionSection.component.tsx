...
const missionCards = [
  {
    ...
    title: 'Kod z Pasją',
    description:
      'Dzielimy się wiedzą o programowaniu w Java w sposób przystępny i inspirujący. Każdy artykuł to dawka motywacji do kodowania.',
  ...
  },
  {
    ...
    description:
      'Oferujemy praktyczne tutoriale, przykłady kodu i real-world projekty, które pomogą Ci rozwijać umiejętności programistyczne.',
  ...
  },
  {
    ...
    title: 'Społeczność',
    description:
      'Budujemy społeczność programistów Java, gdzie każdy może się uczyć, dzielić wiedzą i rozwijać razem z innymi.',
    borderColor: 'border-java-orange/10',
    iconBg: 'bg-java-orange/10',
    iconColor: 'text-java-orange',
  },
    ...
    <div className="py-20 lg:py-28">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          >
            "Wierzymy, że programowanie to nie tylko pisanie kodu, ale tworzenie
            rozwiązań, które zmieniają świat. Każda linia kodu ma swoją
            historię."
          </motion.blockquote>
          <motion.div
